...
moPreviewWindow::moPreviewWindow(wxWindow* parent,wxWindowID id,const wxPoint& pos,const wxSize& size)
{
	...
	BitmapButtonStop = new wxBitmapButton(this, ID_BITMAPBUTTONSTOP, wxBitmap(wxImage( _T(MOLDEODATADIR "/icons/stop32.png"))), wxPoint(96,300), wxSize(32,32), wxBU_AUTODRAW, wxDefaultValidator, _T("ID_BITMAPBUTTON1"));
	BitmapButtonStop->SetDefault();
	BitmapButtonStop->SetToolTip(_("Stop"));
	BitmapButtonStop->SetHelpText(_("Stop"));
	BitmapButtonControl = new wxBitmapButton(this, ID_BITMAPBUTTONCONTROL, wxBitmap(wxImage( _T(MOLDEODATADIR "/icons/joystick32.png"))), wxPoint(128,300), wxSize(32,32), wxBU_AUTODRAW, wxDefaultValidator, _T("ID_BITMAPBUTTONCONTROL"));
