...
moFontPanel::moFontPanel(wxWindow* parent,wxWindowID id,const wxPoint& pos,const wxSize& size)
{
	...
	BitmapButtonImport = new wxBitmapButton(this, ID_BITMAPBUTTONIMPORT, wxBitmap(wxImage(_T("../../art/icons/import.png"))), wxPoint(160,16), wxSize(13,13), wxBU_AUTODRAW, wxDefaultValidator, _T("ID_BITMAPBUTTONIMPORT"));
