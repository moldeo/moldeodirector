...
moPreviewWindow::moPreviewWindow(wxWindow* parent,wxWindowID id,const wxPoint& pos,const wxSize& size)
{
	...
	BitmapButtonPlay = new wxBitmapButton(this, ID_BITMAPBUTTONPLAY, wxBitmap(wxImage(_T(MOLDEODATADIR"/icons/play32.png"))), wxPoint(0,300), wxSize(32+6,32+6), wxBU_AUTODRAW, wxDefaultValidator, _T("ID_BITMAPBUTTONPLAY"));
	BitmapButtonPlay->SetDefault();
	BitmapButtonPlay->SetToolTip(_("Play"));
	BitmapButtonPlay->SetHelpText(_("Play"));
	BitmapButtonPause = new wxBitmapButton(this, ID_BITMAPBUTTONPAUSE, wxBitmap(wxImage(_T(MOLDEODATADIR"/icons/pause32.png"))), wxPoint(32+6,300), wxSize(32+6,32+6), wxBU_AUTODRAW, wxDefaultValidator, _T("ID_BITMAPBUTTONPAUSE"));
	BitmapButtonPause->SetDefault();
	BitmapButtonPause->SetToolTip(_("Pause"));
	BitmapButtonPause->SetHelpText(_("Pause"));
	ButtonFullSCreen = new wxBitmapButton(this, ID_BITMAPBUTTONFULLSCREEN, wxBitmap(wxImage(_T(MOLDEODATADIR"/icons/fullscreen32.png"))), wxPoint((32+6)*6,300), wxSize(32+6,32+6), wxBU_AUTODRAW , wxDefaultValidator, _T("ID_BITMAPBUTTONFULLSCREEN"));
	ButtonFullSCreen->SetDefault();
	ButtonFullSCreen->SetToolTip(_("Fullscreen"));
	ButtonFullSCreen->SetHelpText(_("Fullscreen"));
	BitmapButtonScreenshot = new wxBitmapButton(this, ID_BITMAPBUTTONSCREENSHOT, wxBitmap(wxImage(_T(MOLDEODATADIR"/icons/screenshot32.png"))), wxPoint((32+6)*7,300), wxSize(32+6,32+6), wxBU_AUTODRAW, wxDefaultValidator, _T("ID_BITMAPBUTTONSCREENSHOT"));
	...
	BitmapButtonSaveVideo = new wxBitmapButton(this, ID_BITMAPBUTTONSAVEVIDEO, wxBitmap(wxImage(_T(MOLDEODATADIR"/icons/savevideo32.png"))), wxPoint((32+6)*8,300), wxSize(32+6,32+6), wxBU_AUTODRAW, wxDefaultValidator, _T("ID_BITMAPBUTTONSAVEVIDEO"));
	BitmapButtonSaveVideo->SetDefault();
	BitmapButtonSaveVideo->SetToolTip(_("Movie"));
	BitmapButtonSaveVideo->SetHelpText(_("Movie"));
	BitmapButtonSaveSession = new wxBitmapButton(this, ID_BITMAPBUTTONSAVESESSION, wxBitmap(wxImage(_T(MOLDEODATADIR"/icons/savesession32.png"))), wxPoint((32+6)*2,300), wxSize(32+6,32+6), wxBU_AUTODRAW, wxDefaultValidator, _T("ID_BITMAPBUTTONSAVESESSION"));
	BitmapButtonSaveSession->SetToolTip(_("Record"));
	BitmapButtonSaveSession->SetHelpText(_("Record"));
	BitmapButtonStop = new wxBitmapButton(this, ID_BITMAPBUTTONSTOP, wxBitmap(wxImage(_T(MOLDEODATADIR"/icons/stop32.png"))), wxPoint((32+6)*3,300), wxSize(32+6,32+6), wxBU_AUTODRAW, wxDefaultValidator, _T("ID_BITMAPBUTTONSTOP"));
    ...
    ButtonFullSCreen->SetBackgroundStyle(wxBG_STYLE_COLOUR);
    ButtonFullSCreen->SetBackgroundColour(wxColour(0,0,0));
