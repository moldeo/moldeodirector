...
private:
	...
	//wxStaticText*  _labelwindow;

	//wxStaticBitmap*  _labelwindow;

public:
	TreeMultiItemNode( TreeMultiItemNode *parent, const wxString &caption = wxEmptyString, const wxString &name = wxEmptyString, wxWindow* window = 0);
